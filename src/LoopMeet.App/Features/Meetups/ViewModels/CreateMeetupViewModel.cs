...
public sealed partial class CreateMeetupViewModel : ObservableObject, IHasUnsavedInput
{
    ...
    public bool HasUnsavedInput => !string.IsNullOrWhiteSpace(Title) || HasSelectedLocation;
