...
- [ ] T026 [US3] Add the edit control to `src/LoopMeet.App/Features/Meetups/Views/MeetupDetailPage.xaml`: a pencil text glyph bound to `EditCommand` with `IsVisible="{Binding IsOwner}"` (FR-015, FR-017, FR-021).
